...
(function () {
    ...
    const arcB = svg2
        .append("path")
        .attr("transform", `translate(${centerX + radius}, ${centerY - radius}) rotate(270, 0, 0)`)
        .attr(
            "d",
            d3.arc()({
                innerRadius: 20,
    ...
    const bracketTan = svg2
        ...
        .attr(
            "transform",
            `translate(${centerX - 3}, ${centerY - 60}) rotate(270, 0, 0)`
        );
    ...
    const bracketR = svg2
        ...
        .attr(
            "transform",
            `translate(${centerX + 40}, ${centerY + 5}) rotate(180, 0, 0)`
        );
})();
