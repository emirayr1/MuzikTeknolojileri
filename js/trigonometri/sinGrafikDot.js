(function () {
    ...
    function updatePoints() {
        // Slider değerini al
        const sliderValue = +document.getElementById("dotSlider").value;
        ...
        svg.selectAll(".dash-lineY").remove();
        svg.selectAll(".dash-lineX").remove();
